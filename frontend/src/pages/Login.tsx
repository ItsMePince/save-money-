...
const Login: React.FC<LoginProps> = ({ onLoginSuccess }) => {
    ...
    useEffect(() => {
        ...
        if (authed) {
            const last = sessionStorage.getItem("lastVisitedPath") || "/home";
    ...
    const onSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // --- FIX 2: แปลง "Failed to fetch" เป็นข้อความที่เทสคาดหวัง ---
        ...
        <div className="login-page">
            <div className="card">
                ...
                <form className="form" onSubmit={onSubmit}>
                    ...
                    {error && (
                        // --- FIX 1: เพิ่ม data-testid="login-error" ---
                        <div
                            data-testid="login-error"
                            style={{ color: "#ef4444", fontSize: 14, textAlign: "center", margin: "8px 0" }}
                        >
                            {error}
                        </div>
                        // ------------------------------------------
